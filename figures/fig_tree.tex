...
\node[draw, rounded corners=2pt, align=left, inner sep=4pt, font=\scriptsize] at (0,-3.45) {
  element \ $b=[L]\cup[RL]\cup[RRR]$,\quad depth $d(b)=3$\\[2pt]
  code \ $\underline b=\langle\, \underline{\vee},\ L,\ RL,\ RRR,\ \square\,\square\cdots\square\,\rangle$, \quad $|\underline b| = \ell_3$\\[2pt]
